...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      bullet("MoreNavigator (stack, Session 10): MoreMenu → Materials, PurchaseOrders, PurchaseOrderDetail, SalesOrders, SalesOrderDetail, GRN, Partners, PartnerDetail, Companies, Settings, Alerts"),
