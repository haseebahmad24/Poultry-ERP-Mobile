...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      heading("3.23 Navigation Architecture (Updated Session 8)", HeadingLevel.HEADING_2),
      ...
      bullet("MoreNavigator (stack, Session 8): MoreMenu → Materials, PurchaseOrders, PurchaseOrderDetail, SalesOrders, SalesOrderDetail, GRN, Partners, PartnerDetail, Companies, Settings"),
      ...
      heading("3.25 Offline Caching (Sessions 6–8)", HeadingLevel.HEADING_2),
