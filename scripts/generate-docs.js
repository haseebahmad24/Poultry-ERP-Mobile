...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      bullet("Bills: bill cards with status, amounts, due date"),
      bullet("Vendors: vendor cards with outstanding/overdue balances"),
      body(""),
      ...
      bullet("Invoices: invoice cards with outstanding amounts"),
      bullet("Customers: customer cards with outstanding/overdue balances"),
      body(""),
      ...
      heading("3.22 Global Company Filter", HeadingLevel.HEADING_2),
      ...
      bullet("Inventory, Accounts Payable, Accounts Receivable screens use companyId from context"),
      body(""),

      heading("3.23 Navigation Architecture", HeadingLevel.HEADING_2),
      bullet("AppNavigator (bottom tabs): Dashboard, Inventory, Finance, More"),
      bullet("FinanceNavigator (stack): FinanceMenu → AccountsPayable, AccountsReceivable, JournalEntries, TrialBalance"),
