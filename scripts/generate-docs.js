...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      heading("3.23 Navigation Architecture (Updated Session 7)", HeadingLevel.HEADING_2),
      ...
      heading("3.25 Offline Caching (Session 6)", HeadingLevel.HEADING_2),
      ...
      bullet("OfflineBanner (src/components/OfflineBanner.tsx): amber banner when stale data is displayed"),
      ...
      bullet("src/utils/ — Utility functions: currency.ts (formatting), cache.ts (AsyncStorage offline cache, Session 6)", 0),
